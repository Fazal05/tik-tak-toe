  ...
  e.addEventListener("click", non=()=>{
    ...
    ib++;
      ...
      next.addEventListener("click",nxt=()=>{
        ...
        a.style.backgroundColor="rgb(250, 246, 246)";
         b.style.backgroundColor="rgb(250, 246, 246)";
         c.style.backgroundColor="rgb(250, 246, 246)";
         d.style.backgroundColor="rgb(250, 246, 246)";
         e.style.backgroundColor="rgb(250, 246, 246)";
         f.style.backgroundColor="rgb(250, 246, 246)";
         g.style.backgroundColor="rgb(250, 246, 246)";
         h.style.backgroundColor="rgb(250, 246, 246)"; 
         i.style.backgroundColor="rgb(250, 246, 246)";
